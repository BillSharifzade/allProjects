                ...
                <tr>
                    ...
                    <td class="text-right">
                        <?php if($ls && (int)$ls->closed_at > 0): ?>
                            <a class="btn btn-sm btn-primary" href="/admin/daily-report/<?php echo e($ls->id); ?>/download">Скачать отчет</a>
                        <?php endif; ?>
                    </td>
                </tr>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qwantum/Documents/ngn/nigin/nigin/html/resources/views/admin/daily_report/index.blade.php ENDPATH**/ ?>