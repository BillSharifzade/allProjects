<?php $__env->startSection('content'); ?>
    <h4 class="m-3">Перевод средств кассиру</h4>
    <?php echo app('arrilot.widget')->run('Error'); ?>
    <form action="/transfer" method="post" class="m-3" style="max-width: 420px;">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qwantum/Documents/ngn/nigin/nigin/html/resources/views/cashbox/transfer/create.blade.php ENDPATH**/ ?>