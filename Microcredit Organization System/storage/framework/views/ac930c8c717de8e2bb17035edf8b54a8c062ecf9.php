    ...
    <nav class="navbar navbar-dark bg-dark sticky-top">
        ...
        <div class="d-flex align-items-center">
            <div class="navbar-nav flex-row">
                <a class="nav-link px-3 <?php echo e(Request::route()->getName() == 'inc-safe' ? 'active' : ''); ?>" href="/inc/safe">Сейф</a>
                <a class="nav-link px-3 <?php echo e(Request::route()->getName() == 'inc-todeliver' ? 'active' : ''); ?>" href="/inc/todeliver">Забрать</a>
                <a class="nav-link px-3 <?php echo e(Request::route()->getName() == 'inc-history' ? 'active' : ''); ?>" href="/inc/history">История</a>
            </div>
        </div>
    </nav>
    <div class="p-2">
        <?php echo $__env->yieldContent('inc-content'); ?>
    </div>
</div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qwantum/Documents/ngn/nigin/nigin/html/resources/views/incassator/layout.blade.php ENDPATH**/ ?>