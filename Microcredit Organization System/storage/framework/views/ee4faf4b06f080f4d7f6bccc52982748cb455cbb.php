<?php $__env->startSection('content'); ?>
    ...
    <?php if($loansInitialSum > 0 || $loansLeftSum > 0 || $principalPaymentsTotalSum > 0 || $interestPaymentsTotalSum > 0): ?>
        ...
        <p><a href="/admin/excel/cashbox?from=<?php echo e(request()->get('from')); ?>&to=<?php echo e(request()->get('to')); ?>&cashbox=<?php echo e(request()->get('cashbox')); ?>&audit=<?php echo e(request()->get('audit')); ?>">Загузить в Excel</a></p>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/qwantum/Documents/ngn/nigin/nigin/html/resources/views/admin/report/index.blade.php ENDPATH**/ ?>