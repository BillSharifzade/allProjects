            ...
            <tr>
                ...
                <td>
                    ...
                    @if($t)
                        ...
                        @elseif($t->picked_by_incassator && !$t->delivered_by_incassator)
                ...
                <td style="width:120px;">
                    ...
                    @if($loan->closed_at == 0)
                        <a href="/admin/loans/{{$loan->id}}/update?redirect={{base64_encode(url()->full())}}">
                            <i class="fas fa-edit"></i>
                        </a>
                    @endif

                    <a href="/admin/print/loan/{{$loan->id}}" style="font-size: 16px" class="px-1">
                        <i class="fas fa-print"></i>
                    </a>

                    <a href="/admin/payments?loanId={{$loan->id}}" style="font-size: 16px" class="px-1" target="_blank">
                        <i class="fas fa-receipt"></i>
                    </a>

                    <a href="/admin/notes?loan_id={{$loan->id}}" style="font-size: 16px">
                        <i class="fa-solid fa-comment"></i>
                    </a>

                    @if($loan->closed_at == 0)
                        <a href="/admin/loans/{{$loan->id}}/delete?redirect={{base64_encode(url()->full())}}" style="font-size: 16px" class="px-1">
