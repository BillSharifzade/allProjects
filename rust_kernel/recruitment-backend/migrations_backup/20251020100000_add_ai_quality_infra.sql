...
-- Add metadata columns to tests table
ALTER TABLE tests
ADD COLUMN IF NOT EXISTS ai_metadata JSONB;

-- Add difficulty and topic to questions JSONB (example, needs application logic to populate)
-- This is a comment as it's an application-level change on a JSONB field.
-- Example of what a question in the 'questions' array might look like now:
-- { "id": 1, "type": "multiple_choice", ..., "topic": "Rust", "difficulty": "medium" }
