...
<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
    <div class="my-auto mb-2">
        <h2 class="mb-1">Qwasar Services</h2>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Qwasar Services Page</h4>
                    </div>
...
<!-- /Breadcrump -->
@include('pages.admin.qwasarServices.modals')

<script>
    function openUpdateModal(recordId) {
        fetch(`/dashboard/qwasarServices/getById/${recordId}`, {
            method: 'GET',
        })
    ...
    function changeStatus(id, status){
        fetch(`/dashboard/qwasarServices/changeStatus/${id}/${status}`, {
            method: 'GET',
        })
            .then(response => response.json())
            .then(data => {
