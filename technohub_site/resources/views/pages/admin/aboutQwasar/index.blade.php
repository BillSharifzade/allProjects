    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">About Qwasar Page</h4>
                    </div>
                   @if(blank($aboutQwasar))
                        ...
                        <tbody>
                            @if(!blank($aboutQwasar))
                                <tr>
                                    ...
                                    <td>
                                        {{date('Y-m-d', strtotime($aboutQwasar->created_at))}}
                                    </td>
                                    <td>
                                        <div class="action-icon d-inline-flex">
                                            <a href="#" class="me-2" data-bs-toggle="modal" data-bs-target="#edit_modal" onclick="openUpdateModal({{$aboutQwasar->id}})">
                                                <i class="ti ti-edit"></i>
                                            </a>
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#delete_modal" onclick="openDeleteModal({{$aboutQwasar->id}})">
...
<!-- /Breadcrump -->
@include('pages.admin.aboutQwasar.modals')

<script>
    function openUpdateModal(recordId) {
        fetch(`/dashboard/aboutQwasar/getById/${recordId}`, {
            method: 'GET',
        })
