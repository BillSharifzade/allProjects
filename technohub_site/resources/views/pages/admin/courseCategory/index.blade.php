...
<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
    <div class="my-auto mb-2">
        <h2 class="mb-1">Course Category</h2>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Course Category Page</h4>
                    </div>
...
<!-- /Breadcrump -->
@include('pages.admin.courseCategory.modals')

<script>
    function openUpdateModal(recordId) {
        fetch(`/dashboard/courseCategory/getById/${recordId}`, {
            method: 'GET',
        })
    ...
    function changeStatus(id, status){
        fetch(`/dashboard/courseCategory/changeStatus/${id}/${status}`, {
            method: 'GET',
        })
            .then(response => response.json())
            .then(data => {
