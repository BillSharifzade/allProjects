    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">Events Page</h4>
                    </div>
...
<!-- /Breadcrump -->
@include('pages.admin.events.modals')

<script>
    function openUpdateModal(recordId) {
        fetch(`/dashboard/events/getById/${recordId}`, {
            method: 'GET',
        })
    ...
    function changeStatus(id, status){
        fetch(`/dashboard/events/changeStatus/${id}/${status}`, {
            method: 'GET',
        })
            .then(response => response.json())
            .then(data => {
