...
<div class="modal fade" id="edit_modal" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{route('courses.update')}}" id="updateForm" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
...
<div class="modal fade" id="delete_modal" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{route('courses.delete')}}" id="updateForm" method="POST" enctype="multipart/form-data">
                @method('DELETE')
                @csrf
