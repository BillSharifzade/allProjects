...
@section('content')
    <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
        ...
        <div class="container">
            <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Контакты</h2>
            <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <a href="/">Главная</a><span><i class="fa-regular fa-angles-right mx-2"></i>Контакты</span>
            </div>
        </div>
    </section>
                    ...
                    <div class="contact__left-item primary-bg">
                        ...
                        <ul class="mt-40 mb-40">
                            <li>
                                ...
                                <div>
                                    <span class="text-white">Контактный телефон</span>
                                    <h3 class="mt-1"><a class="text-white" href="tel:+2085550112">+992 710 44 9999</a>
                                    </h3>
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    <span class="text-white">Контактная почта</span>
                            ...
                            <li>
                                ...
                                <div>
                                    ...
                                    <h3 class="mt-1"><a class="text-white">Душанбе Айни 55</a>
                                    </h3>
                                </div>
                            </li>
                        </ul>
