      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md">
              Quant is revolutionizing digital consumption by replacing mindless scrolling with enriching scientific content. 
              Discover a world of knowledge, one scroll at a time.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#science" className="text-gray-400 hover:text-secondary transition-colors">
                  Science
                </Link>
              </li>
              <li>
                <Link href="#skills" className="text-gray-400 hover:text-secondary transition-colors">
                  Skills
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {currentYear} Quant. All rights reserved.
          </p>
