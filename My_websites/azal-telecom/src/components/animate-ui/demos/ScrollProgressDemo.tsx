...
export const ScrollProgressDemo = ({ global = false, direction = 'vertical' }: ScrollProgressDemoProps) => {
    return (
            ...
            <div className="relative h-full w-full overflow-hidden">
                <ScrollProgressProvider global={global} direction={direction}>
                    <div
                        className={cn(
                            'z-50 ',
                            global ? 'fixed top-0 left-0 right-0' : 'absolute bottom-3 left-3 right-3'
                        )}
                    >
                    ...
                    {global ? (
                        ...
                        <ScrollProgressContainer className="w-full h-full data-[direction=vertical]:overflow-y-auto data-[direction=horizontal]:overflow-x-auto">
                            <div className={cn('flex', direction === 'vertical' && 'flex-col')}>
